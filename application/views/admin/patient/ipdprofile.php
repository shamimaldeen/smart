...
<?php } ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="payment_date" id="date" value="<?php echo html_escape($date); ?>" class="form-control date">
                                        <span class="text-danger"><?php echo form_error('apply_charge'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <label><?php echo $this->lang->line('date'); ?></label> <small class="req"> *</small> 
                                        <input id="charge_date" name="date" placeholder="" value="<?php echo html_escape($date); ?>" type="text" class="form-control date" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
...
<?php } ?>
                            ...
                            <div class="row">
                                <div class="box-footer">
                                    ...
                                    <button type="submit" id="add_another_chargesbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-warning pull-right">Save And Another</button>
                                </div>
                            </div>
                        </form>
                    </div>
